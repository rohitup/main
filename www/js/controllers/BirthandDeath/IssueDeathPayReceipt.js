...
.controller('IssueDeathPayReceiptCtrl', function ($scope, $http, RestService, $ionicLoading, $stateParams, toaster, $filter,
	...
	/*$scope.deathPayReceiptapplID = $scope.issueDeathReceiptResponse.applicationId;
	$scope.deathPayReceiptcertificateAmt = makeFloat($scope.issueDeathReceiptResponse.certificateAmount);
	$scope.applicantName = "Login User Name";
	$scope.mobileNumber = "9664611565";
	$scope.EmailID= "gajendra@gmail.com";*/
	
	$scope.applicationID = $scope.issueDeathReceiptResponse.applicationId;
	$scope.applnDueAmount = makeFloat($scope.issueDeathReceiptResponse.certificateAmount);
	$scope.applicantName = "Login User Name";
	$scope.mobileNumber = "9664611565";
	$scope.EmailID= "gajendra@gmail.com";
	...
	$scope.BankListChange = function() 
	 ...
	 $scope.issuedeathpaychange = function()
	 {
	 	$scope.$watch('issuedeathPay', function(newVal) {
	 		console.log("$scope.issuedeathPay--"+$scope.issuedeathPay);
	 		 for(var i=0;i<$scope.bankNameList.length;i++){
	 			 $scope.optbankname = $scope.bankNameList[i].bankId;
	 			 if($scope.issuedeathPay == $scope.optbankname)
	 				 {
	...
	/*Function Declaration End*/
	 ...
	 $scope.paymentgateway = function()
	 {
		    console.log("$scope.orgID--"+$scope.orgID);
		 	console.log("$scope.issuedeathPay--"+$scope.issuedeathPay); //var paymentGatewayTypeValue = "RTIpaymentgateway";
		...
		if($scope.issuedeathPay==null || $scope.issuedeathPay==undefined || $scope.issuedeathPay=="")
		 	{
