angular.module('starter')
  .controller('propertyTaxReceiptCtrl', function ($scope, RestService, $ionicLoading, $stateParams, toaster, $filter, 
		  ENV, $state, sharedProperties,$http) {
...
//cordova.exec(sayHelloSuccess,sayHelloFailure,"HelloWorldPlugin","sayHello",[wOwNam]);
		...
		setTimeout(function() {
         ...
         bluetoothSerial.write(data);
         bluetoothSerial.write(data);
         bluetoothSerial.write(wNo);
         bluetoothSerial.write(data);                   
         bluetoothSerial.write(wRecptNo);
		 bluetoothSerial.write(data);
		 bluetoothSerial.write(wOwNam);
         bluetoothSerial.write(data);
         bluetoothSerial.write(wRecpDat);
         bluetoothSerial.write(data);
		...
		bluetoothSerial.write(orgname);
         ...
         bluetoothSerial.write(breakline);
         bluetoothSerial.write(wNo);
		 bluetoothSerial.write($("#proreceiptpNo").text());
		 bluetoothSerial.write(breakline); 
         bluetoothSerial.write(wRecptNo);
		 bluetoothSerial.write($("#iPropreceiptno").text());
		 bluetoothSerial.write(breakline); 
		 bluetoothSerial.write(wRecpDat);
         bluetoothSerial.write(breakline);
         bluetoothSerial.write(wOwNam);
		 bluetoothSerial.write($("#propReceiptOwnerName").text());
         bluetoothSerial.write(breakline);
		 bluetoothSerial.write(wOwPhone);
		 bluetoothSerial.write(breakline);
         bluetoothSerial.write(wRecpPayAm);
         bluetoothSerial.write(breakline);
         bluetoothSerial.write(wPaidAm);
